...
app.appendChild(toolbarWrapper); 
...
function drawLogo(){
    ...
    logo.style.backgroundImage = 'url("assets/gameIcons/mindmap.png")'
...
function drawTimer(){
    ...
    clockIcon.style.backgroundImage = 'url("assets/clock.png")'
...
function drawScore(){
    ...
    scoreIcon.style.backgroundImage = 'url("assets/score.png")'
